...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyCsbzuJDUEOoq-jS1HO-LUXW4qo0gW9FNs'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center						= "50.853, 4.272";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	var $clusterMaxZoom				= '19';						// The maximum zoom level that a marker can be part of a cluster
	//ADD BY KHALID
	var $clusterIcon 				= FALSE;
	...
	var $clusterMinimumClusterSize	= 5;						// The minimum number of markers to be in a cluster before the markers are hidden and a count is shown
	...
	var $minzoom					= '10';						// The minimum zoom level which will be displayed on the map
	var $maxzoom					= '19';						// The maximum zoom level which will be displayed on the map
	...
	function create_map()
	{
		...
		if ($this->cluster) {
			...
			if ($this->clusterAverageCenter) { $this->output_js_contents .= ',
				averageCenter: true'; }
			//ADD BY KHALID
			if ($this->clusterIcon) { $this->output_js_contents .= ',
				imagePath: "'.$this->clusterIcon.'"';}
			$this->output_js_contents .= ',
